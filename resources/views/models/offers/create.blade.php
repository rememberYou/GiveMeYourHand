...
@section('content')
	...
	<div class="row">
	    <div class="col-md-8 col-md-offset-2">
		    ...
		    {!! Form::open(['route' => 'offers.store', 'data-parsley-validate' => '']) !!}

		    <h2 class="text-center design-title fg-emerald wow fadeIn"
			       style="visibility: visible; animation-name: fadeIn">Creation Panel</h2>
		    ...
		    <div class="form-group wow fadeInLeft"
			 style="visibility: visible; animation-name: fadeInLeft">
                        <div class="text-center">
			    <span class="span-login">or {!! Html::linkRoute('offers.index', 'Cancel', null) !!}</span>
                        </div>
		    </div>
		    {!! Form::close() !!}
		</div> <!-- ./design-box -->
